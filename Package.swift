    ...
    targets: [
        ...
        .target(
            ...
            sources: [
                ...
                "Sources/LlamaCppMTMD/mtmd-audio.cpp",
                "Vendor/llama.cpp/tools/mtmd/mtmd-image.cpp",
                "Vendor/llama.cpp/tools/mtmd/mtmd-helper.cpp",
                "Vendor/llama.cpp/tools/mtmd/clip.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/cogvlm.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/conformer.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/dotsocr.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/gemma4a.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/gemma4v.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/glm4v.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/granite-speech.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/hunyuanvl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/internvl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/kimivl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/kimik25.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/nemotron-v2-vl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/llama4.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/llava.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/minicpmv.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/paddleocr.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/pixtral.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/qwen2vl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/qwen3vl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/mimovl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/qwen3a.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/step3vl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/siglip.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/whisper-enc.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/deepseekocr.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/mobilenetv5.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/youtuvl.cpp",
                "Vendor/llama.cpp/tools/mtmd/models/yasa2.cpp"
            ],
            publicHeadersPath: "Vendor/llama.cpp/tools/mtmd",
            cxxSettings: [
